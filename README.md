...
The number of attacks are as in the screenshot below, I couldn't view the attack report so I tried to create another honeypot and work it out but it doesn't work. I don't know what is causing the problem.

<img src= "https://github.com/vaidehirana/Week-9-Honeypot-Project/blob/master/Summary%20of%20Attacks.JPG" width="800">

My nmap results are as below:

<img src= "https://github.com/vaidehirana/Week-9-Honeypot-Project/blob/master/nmap.JPG" width="800">

Any unresolved questions raised by the data collected? Yes, I had a fatal error for geoloc, I don't know how to fix it and I think that is the reason I am not able to see the attack report. I couldn't figure out why I am not able to get attack report, stats and export json file.
<img src= "https://github.com/vaidehirana/Week-9-Honeypot-Project/blob/master/Error%20geoloc.JPG" width="800">
